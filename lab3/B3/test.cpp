...
void student_setting() {
    ...
    //std::cout<<"Enter a1 and a2(a2<12 to exit)";
    //std::cin>>a1;
    //std::cin>>a2;
    a1=30;a2=12;
}
...
int main() {
    ...
    if(a2 >= 12) {
        ...
        while_flag = new char[a2 - 12 + 2];

        random_buffer = new char[a2 - 12 + 2];
        ...
        memset(while_flag, 0, a2 - 12 + 2);

        memset(random_buffer, 0, a2 - 12 + 2);
